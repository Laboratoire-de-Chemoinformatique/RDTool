 ...
 */
public class MappingThread implements Callable<Reactor> {
     ...
     */
    public MappingThread(String message, IReaction cleanedReaction, IMappingAlgorithm algorithm, boolean removeHydrogen) {
