...
//                }
    ...
    private synchronized void setVFMappings(List<AtomAtomMapping> mappingsVF2) {
        ...
        int timeout = cache.containsKey("timeout") ? cache.get("timeout") : -1;
        ...
        for (AtomAtomMapping solution : mappingsVF2) {
            ...
            if (timeout > 0 && elapsed > timeout) {
                System.out.println("Substructure.setVFMappings is interrupted due to timeout, time elapsed = " + elapsed);
                break;
            }
